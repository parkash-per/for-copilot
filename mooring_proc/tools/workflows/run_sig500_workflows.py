"""Explicit SIG500 workflow entry points."""
...
def run_sig500_proc1(config, instrument_id=None, source_path=None):
    return run_proc1(config, instrument_id=instrument_id, source_path=source_path)


def run_sig500_proc2(config, instrument_id=None, input_dataset=None):
    return run_proc2(config, instrument_id=instrument_id, input_dataset=input_dataset)


def run_sig500_delivery(config, instrument_id=None, input_dataset=None):
